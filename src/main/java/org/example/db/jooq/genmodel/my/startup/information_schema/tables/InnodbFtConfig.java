...
import my.startup.information_schema.tables.records.InnodbFtConfigRecord;
...
public class InnodbFtConfig extends TableImpl<InnodbFtConfigRecord> {
    ...
    private static final long serialVersionUID = -1792805331;
     ...
     */
    public final TableField<InnodbFtConfigRecord, String> KEY = createField(DSL.name("KEY"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_FT_CONFIG.VALUE</code>.
     */
    public final TableField<InnodbFtConfigRecord, String> VALUE = createField(DSL.name("VALUE"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
