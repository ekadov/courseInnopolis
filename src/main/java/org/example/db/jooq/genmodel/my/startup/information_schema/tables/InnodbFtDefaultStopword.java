...
import my.startup.information_schema.tables.records.InnodbFtDefaultStopwordRecord;
...
public class InnodbFtDefaultStopword extends TableImpl<InnodbFtDefaultStopwordRecord> {
    ...
    private static final long serialVersionUID = 2146808422;
     ...
     */
    public final TableField<InnodbFtDefaultStopwordRecord, String> VALUE = createField(DSL.name("value"), org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
