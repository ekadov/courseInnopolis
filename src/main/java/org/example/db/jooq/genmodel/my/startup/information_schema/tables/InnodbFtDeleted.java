...
import my.startup.information_schema.tables.records.InnodbFtDeletedRecord;
...
public class InnodbFtDeleted extends TableImpl<InnodbFtDeletedRecord> {
    ...
    private static final long serialVersionUID = 1906542159;
     ...
     */
    public final TableField<InnodbFtDeletedRecord, ULong> DOC_ID = createField(DSL.name("DOC_ID"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
