...
import my.startup.information_schema.tables.records.StGeometryColumnsRecord;
...
public class StGeometryColumns extends TableImpl<StGeometryColumnsRecord> {
    ...
    private static final long serialVersionUID = -1943944306;
     ...
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_CATALOG = createField(DSL.name("TABLE_CATALOG"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.TABLE_SCHEMA</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_SCHEMA = createField(DSL.name("TABLE_SCHEMA"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.TABLE_NAME</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.COLUMN_NAME</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> COLUMN_NAME = createField(DSL.name("COLUMN_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.SRS_NAME</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> SRS_NAME = createField(DSL.name("SRS_NAME"), org.jooq.impl.SQLDataType.VARCHAR(80), this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.SRS_ID</code>.
     */
    public final TableField<StGeometryColumnsRecord, UInteger> SRS_ID = createField(DSL.name("SRS_ID"), org.jooq.impl.SQLDataType.INTEGERUNSIGNED, this, "");

    /**
     * The column <code>information_schema.ST_GEOMETRY_COLUMNS.GEOMETRY_TYPE_NAME</code>.
     */
    public final TableField<StGeometryColumnsRecord, String> GEOMETRY_TYPE_NAME = createField(DSL.name("GEOMETRY_TYPE_NAME"), org.jooq.impl.SQLDataType.CLOB, this, "");
