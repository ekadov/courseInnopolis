...
import my.startup.information_schema.tables.records.TablespacesExtensionsRecord;
...
public class TablespacesExtensions extends TableImpl<TablespacesExtensionsRecord> {
    ...
    private static final long serialVersionUID = -713937272;
     ...
     */
    public final TableField<TablespacesExtensionsRecord, String> TABLESPACE_NAME = createField(DSL.name("TABLESPACE_NAME"), org.jooq.impl.SQLDataType.VARCHAR(268).nullable(false), this, "");

    /**
     * The column <code>information_schema.TABLESPACES_EXTENSIONS.ENGINE_ATTRIBUTE</code>.
     */
    public final TableField<TablespacesExtensionsRecord, JSON> ENGINE_ATTRIBUTE = createField(DSL.name("ENGINE_ATTRIBUTE"), org.jooq.impl.SQLDataType.JSON, this, "");
