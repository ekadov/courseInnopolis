...
import my.startup.information_schema.tables.records.InnodbCachedIndexesRecord;
...
public class InnodbCachedIndexes extends TableImpl<InnodbCachedIndexesRecord> {
    ...
    private static final long serialVersionUID = -200253175;
     ...
     */
    public final TableField<InnodbCachedIndexesRecord, UInteger> SPACE_ID = createField(DSL.name("SPACE_ID"), org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_CACHED_INDEXES.INDEX_ID</code>.
     */
    public final TableField<InnodbCachedIndexesRecord, ULong> INDEX_ID = createField(DSL.name("INDEX_ID"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_CACHED_INDEXES.N_CACHED_PAGES</code>.
     */
    public final TableField<InnodbCachedIndexesRecord, ULong> N_CACHED_PAGES = createField(DSL.name("N_CACHED_PAGES"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
