...
import my.startup.information_schema.tables.records.StUnitsOfMeasureRecord;
...
public class StUnitsOfMeasure extends TableImpl<StUnitsOfMeasureRecord> {
    ...
    private static final long serialVersionUID = 1907840868;
     ...
     */
    public final TableField<StUnitsOfMeasureRecord, String> UNIT_NAME = createField(DSL.name("UNIT_NAME"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>information_schema.ST_UNITS_OF_MEASURE.UNIT_TYPE</code>.
     */
    public final TableField<StUnitsOfMeasureRecord, String> UNIT_TYPE = createField(DSL.name("UNIT_TYPE"), org.jooq.impl.SQLDataType.VARCHAR(7), this, "");

    /**
     * The column <code>information_schema.ST_UNITS_OF_MEASURE.CONVERSION_FACTOR</code>.
     */
    public final TableField<StUnitsOfMeasureRecord, Double> CONVERSION_FACTOR = createField(DSL.name("CONVERSION_FACTOR"), org.jooq.impl.SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>information_schema.ST_UNITS_OF_MEASURE.DESCRIPTION</code>.
     */
    public final TableField<StUnitsOfMeasureRecord, String> DESCRIPTION = createField(DSL.name("DESCRIPTION"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
