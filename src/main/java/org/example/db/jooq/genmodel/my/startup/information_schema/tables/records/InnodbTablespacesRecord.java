...
public class InnodbTablespacesRecord extends TableRecordImpl<InnodbTablespacesRecord> implements Record15<UInteger, String, UInteger, String, UInteger, UInteger, String, UInteger, ULong, ULong, ULong, String, UInteger, String, String> {
    ...
    private static final long serialVersionUID = 531089378;
    ...
    /**
     * Setter for <code>information_schema.INNODB_TABLESPACES.AUTOEXTEND_SIZE</code>.
     */
    ...
    /**
     * Getter for <code>information_schema.INNODB_TABLESPACES.AUTOEXTEND_SIZE</code>.
     */
    ...
    public InnodbTablespacesRecord(UInteger space, String name, UInteger flag, String rowFormat, UInteger pageSize, UInteger zipPageSize, String spaceType, UInteger fsBlockSize, ULong fileSize, ULong allocatedSize, ULong autoextendSize, String serverVersion, UInteger spaceVersion, String encryption, String state) {
        ...
        set(8, fileSize);
        set(9, allocatedSize);
        set(10, autoextendSize);
        set(11, serverVersion);
        set(12, spaceVersion);
        set(13, encryption);
        set(14, state);
    }
