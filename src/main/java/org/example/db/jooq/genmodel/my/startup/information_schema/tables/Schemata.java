...
import my.startup.information_schema.enums.SchemataDefaultEncryption;
import my.startup.information_schema.tables.records.SchemataRecord;
...
public class Schemata extends TableImpl<SchemataRecord> {
    ...
    private static final long serialVersionUID = -333729092;
     ...
     */
    public final TableField<SchemataRecord, String> CATALOG_NAME = createField(DSL.name("CATALOG_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.SCHEMATA.SCHEMA_NAME</code>.
     */
    public final TableField<SchemataRecord, String> SCHEMA_NAME = createField(DSL.name("SCHEMA_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.SCHEMATA.DEFAULT_CHARACTER_SET_NAME</code>.
     */
    public final TableField<SchemataRecord, String> DEFAULT_CHARACTER_SET_NAME = createField(DSL.name("DEFAULT_CHARACTER_SET_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.SCHEMATA.DEFAULT_COLLATION_NAME</code>.
     */
    public final TableField<SchemataRecord, String> DEFAULT_COLLATION_NAME = createField(DSL.name("DEFAULT_COLLATION_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.SCHEMATA.SQL_PATH</code>.
     */
    public final TableField<SchemataRecord, byte[]> SQL_PATH = createField(DSL.name("SQL_PATH"), org.jooq.impl.SQLDataType.BINARY, this, "");

    /**
     * The column <code>information_schema.SCHEMATA.DEFAULT_ENCRYPTION</code>.
     */
    public final TableField<SchemataRecord, SchemataDefaultEncryption> DEFAULT_ENCRYPTION = createField(DSL.name("DEFAULT_ENCRYPTION"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(my.startup.information_schema.enums.SchemataDefaultEncryption.class), this, "");
