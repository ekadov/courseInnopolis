...
import my.startup.information_schema.tables.records.InnodbFieldsRecord;
...
public class InnodbFields extends TableImpl<InnodbFieldsRecord> {
    ...
    private static final long serialVersionUID = 684744913;
     ...
     */
    public final TableField<InnodbFieldsRecord, byte[]> INDEX_ID = createField(DSL.name("INDEX_ID"), org.jooq.impl.SQLDataType.VARBINARY(256), this, "");

    /**
     * The column <code>information_schema.INNODB_FIELDS.NAME</code>.
     */
    public final TableField<InnodbFieldsRecord, String> NAME = createField(DSL.name("NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.INNODB_FIELDS.POS</code>.
     */
    public final TableField<InnodbFieldsRecord, ULong> POS = createField(DSL.name("POS"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
