...
import my.startup.information_schema.tables.records.InnodbColumnsRecord;
...
public class InnodbColumns extends TableImpl<InnodbColumnsRecord> {
    ...
    private static final long serialVersionUID = 590045444;
     ...
     */
    public final TableField<InnodbColumnsRecord, ULong> TABLE_ID = createField(DSL.name("TABLE_ID"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.NAME</code>.
     */
    public final TableField<InnodbColumnsRecord, String> NAME = createField(DSL.name("NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.POS</code>.
     */
    public final TableField<InnodbColumnsRecord, ULong> POS = createField(DSL.name("POS"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.MTYPE</code>.
     */
    public final TableField<InnodbColumnsRecord, Integer> MTYPE = createField(DSL.name("MTYPE"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.PRTYPE</code>.
     */
    public final TableField<InnodbColumnsRecord, Integer> PRTYPE = createField(DSL.name("PRTYPE"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.LEN</code>.
     */
    public final TableField<InnodbColumnsRecord, Integer> LEN = createField(DSL.name("LEN"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.HAS_DEFAULT</code>.
     */
    public final TableField<InnodbColumnsRecord, Integer> HAS_DEFAULT = createField(DSL.name("HAS_DEFAULT"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_COLUMNS.DEFAULT_VALUE</code>.
     */
    public final TableField<InnodbColumnsRecord, String> DEFAULT_VALUE = createField(DSL.name("DEFAULT_VALUE"), org.jooq.impl.SQLDataType.CLOB.defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CLOB)), this, "");
