...
import my.startup.information_schema.tables.records.SchemataExtensionsRecord;
...
public class SchemataExtensions extends TableImpl<SchemataExtensionsRecord> {
    ...
    private static final long serialVersionUID = -1480000683;
     ...
     */
    public final TableField<SchemataExtensionsRecord, String> CATALOG_NAME = createField(DSL.name("CATALOG_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.SCHEMATA_EXTENSIONS.SCHEMA_NAME</code>.
     */
    public final TableField<SchemataExtensionsRecord, String> SCHEMA_NAME = createField(DSL.name("SCHEMA_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.SCHEMATA_EXTENSIONS.OPTIONS</code>.
     */
    public final TableField<SchemataExtensionsRecord, String> OPTIONS = createField(DSL.name("OPTIONS"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
