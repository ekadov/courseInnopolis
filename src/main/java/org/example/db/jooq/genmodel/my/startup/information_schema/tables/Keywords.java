...
import my.startup.information_schema.tables.records.KeywordsRecord;
...
public class Keywords extends TableImpl<KeywordsRecord> {
    ...
    private static final long serialVersionUID = -353663604;
     ...
     */
    public final TableField<KeywordsRecord, String> WORD = createField(DSL.name("WORD"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>information_schema.KEYWORDS.RESERVED</code>.
     */
    public final TableField<KeywordsRecord, Integer> RESERVED = createField(DSL.name("RESERVED"), org.jooq.impl.SQLDataType.INTEGER, this, "");
