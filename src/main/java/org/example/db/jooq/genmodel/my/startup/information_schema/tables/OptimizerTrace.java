...
import my.startup.information_schema.tables.records.OptimizerTraceRecord;
...
public class OptimizerTrace extends TableImpl<OptimizerTraceRecord> {
    ...
    private static final long serialVersionUID = -1101730172;
     ...
     */
    public final TableField<OptimizerTraceRecord, String> QUERY = createField(DSL.name("QUERY"), org.jooq.impl.SQLDataType.VARCHAR(21845).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.OPTIMIZER_TRACE.TRACE</code>.
     */
    public final TableField<OptimizerTraceRecord, String> TRACE = createField(DSL.name("TRACE"), org.jooq.impl.SQLDataType.VARCHAR(21845).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.OPTIMIZER_TRACE.MISSING_BYTES_BEYOND_MAX_MEM_SIZE</code>.
     */
    public final TableField<OptimizerTraceRecord, Integer> MISSING_BYTES_BEYOND_MAX_MEM_SIZE = createField(DSL.name("MISSING_BYTES_BEYOND_MAX_MEM_SIZE"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.OPTIMIZER_TRACE.INSUFFICIENT_PRIVILEGES</code>.
     */
    public final TableField<OptimizerTraceRecord, Byte> INSUFFICIENT_PRIVILEGES = createField(DSL.name("INSUFFICIENT_PRIVILEGES"), org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.TINYINT)), this, "");
