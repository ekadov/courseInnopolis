...
import my.startup.information_schema.tables.records.ColumnStatisticsRecord;
...
public class ColumnStatistics extends TableImpl<ColumnStatisticsRecord> {
    ...
    private static final long serialVersionUID = -311127587;
     ...
     */
    public final TableField<ColumnStatisticsRecord, String> SCHEMA_NAME = createField(DSL.name("SCHEMA_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMN_STATISTICS.TABLE_NAME</code>.
     */
    public final TableField<ColumnStatisticsRecord, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMN_STATISTICS.COLUMN_NAME</code>.
     */
    public final TableField<ColumnStatisticsRecord, String> COLUMN_NAME = createField(DSL.name("COLUMN_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMN_STATISTICS.HISTOGRAM</code>.
     */
    public final TableField<ColumnStatisticsRecord, JSON> HISTOGRAM = createField(DSL.name("HISTOGRAM"), org.jooq.impl.SQLDataType.JSON.nullable(false), this, "");
